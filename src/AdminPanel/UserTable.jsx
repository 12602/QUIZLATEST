        ...
        <tr className="bg-white">
          ...
          <td>
            <p className="fw-normal mb-1">
              <MDBBtn onClick={viewResults}>View Attempted Quiz</MDBBtn>
            </p>
          </td>
        </tr>
      )}
